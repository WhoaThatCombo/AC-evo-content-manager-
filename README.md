...
- Set the in-game **year** outside **2020–2035**. Anything else crashes the dedicated server before it binds 9700.
...
Tag must match `VERSION` in `acecm/version.py` (`git tag v0.7.8 && git push origin v0.7.8`).
